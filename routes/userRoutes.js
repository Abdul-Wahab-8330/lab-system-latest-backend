...
const { Register, Login, getAllUsers, deleteUser, changePassword, resetUserPassword, updateUserPermissions } = require('../controller/userController');
...
router.put('/permissions/:userId', verifyToken, updateUserPermissions);
